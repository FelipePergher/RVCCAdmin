...
//    type: 'bar',
//    data: {
//        labels: ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'agosto', 'setembro', 'outubro', 'novembro', 'dezembro', 'janeiro', 'fevereiro', 'março', 'abril'],
//        datasets: [{
//            label: 'Exemplo',
//            backgroundColor: 'rgba(255,255,255,.2)',
//            borderColor: 'rgba(255,255,255,.55)',
...
var brandBoxChartLabels = ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho'];
